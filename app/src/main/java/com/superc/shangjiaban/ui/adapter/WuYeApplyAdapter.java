...
public class WuYeApplyAdapter extends RecyclerView.Adapter<WuYeApplyAdapter.ViewHolder> {
    ...
    public WuYeApplyAdapter(Context context, List<PropertyYjBean.DateBean> classList) {
        mContext = context;
